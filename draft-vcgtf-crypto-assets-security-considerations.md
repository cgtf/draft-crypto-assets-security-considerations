...
The signature key for transaction singing is not recorded in the assets data. (See: {{a-basic-model-of-cryptoassets-custodians-system-and-its-functional-components}})
